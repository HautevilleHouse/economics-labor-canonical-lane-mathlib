import EconomicsLaborCanonicalLaneLean.PerelmanEntropy

namespace HautevilleHouse
namespace EconomicsLaborCanonicalLaneLean

structure NoncollapsingPackage {G : RiemannianCurvaturePackage} {F : RicciFlowPDEPackage G} (Epkg : PerelmanEntropyPackage S) where
